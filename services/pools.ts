...
export const Factories = {
  ...
  enemy: () => ({
      id: '', x: 0, y: 0, vx: 0, vy: 0, hp: 0, maxHp: 0, type: 'chaser', speed: 0, size: 0, color: '',
      isElite: false, xp: 0, score: 0, shootTimer: 0, attackTimer: 0, phase: 0, dead: false, active: false,
      life: 0, hitFlash: 0, rotation: 0, sides: 0,
      history: [], trail: [], modules: undefined, behavior: undefined,
      statusFlags: 0, statusTimers: new Float32Array(8) // Pre-allocate
  }),
  resetEnemy: (e: any) => { 
